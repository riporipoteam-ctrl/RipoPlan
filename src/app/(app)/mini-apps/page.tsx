    ...
    <>
      ...
      <div className="flex flex-1 flex-col items-center justify-center gap-3 px-6 py-16 text-center">
        ...
        <p className="max-w-xs text-sm text-[var(--muted)]">
          ...
          Create an agent with a schedule to turn it into a recurring app.
        </p>
        <Link href="/agents/new" className="mt-2 flex items-center gap-2 rounded-xl bg-gradient-to-br from-nebula-600 to-nebula-pink px-4 py-2.5 text-sm font-semibold text-white">
